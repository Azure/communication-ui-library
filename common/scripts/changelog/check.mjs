...
async function main() {
  ...
  if (newChangeFilesCount === 0) {
    console.error('No changefile detected! Please run `rush changelog` to document your change. If your changes do not affect the published packages in any way, please add `do not need changelog` label to the PR.');
    process.exit(1);
  }
