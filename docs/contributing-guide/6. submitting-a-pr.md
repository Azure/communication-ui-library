...
If you are adding/updating dependencies in any of package.json file, you will need to update dependencies lock files for both beta and stable flavors before submitting changes, run these command to ensure they are correctly generated:
