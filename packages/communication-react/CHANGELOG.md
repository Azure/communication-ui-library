...
### Bug Fixes
  ...
  - Increase Z-index of jump to new message button to 2 so the button stays on top of message bubbles ([PR #2046](https://github.com/Azure/communication-ui-library/pull/2046) by carolinecao@microsoft.com)
