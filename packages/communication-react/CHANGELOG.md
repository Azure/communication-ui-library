...
## [1.3.2-beta.2](https://github.com/azure/communication-ui-library/tree/1.3.2-beta.2)

Thu, 20 Oct 2022 20:49:50 GMT
[Compare changes](https://github.com/azure/communication-ui-library/compare/1.3.2-beta.1...1.3.2-beta.2)

This beta release enables clients to use a wider range of the Azure Communication Services peer depenendencies (i.e. @azure/communication-chat and @azure/communication-calling) in their applications.
