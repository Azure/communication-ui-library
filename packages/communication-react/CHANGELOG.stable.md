...
## [1.11.0](https://github.com/azure/communication-ui-library/tree/@azure/communication-react_v1.11.0)

Mon, 11 Dec 2023 21:24:49 GMT 
[Compare changes](https://github.com/azure/communication-ui-library/compare/@azure/communication-react_v1.11.0-beta.1...@azure/communication-react_v1.11.0)
...
- Introduce the calling sound for ringing, only plays when calling teams and ACS users, not PSTN ([PR #3784](https://github.com/azure/communication-ui-library/pull/3784) by 94866715+dmceachernmsft@users.noreply.github.com)
- String translation for beta release ([PR #3811](https://github.com/azure/communication-ui-library/pull/3811) by carolinecao@microsoft.com)
...
- Introduce sound options API to CallAdapter options ([PR #3775](https://github.com/azure/communication-ui-library/pull/3775) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Introduce testing for calling sounds on the CallAdapter implementation ([PR #3795](https://github.com/azure/communication-ui-library/pull/3795) by 94866715+dmceachernmsft@users.noreply.github.com)
- undefined ([PR #3800](https://github.com/azure/communication-ui-library/pull/3800) by 79475487+mgamis-msft@users.noreply.github.com)
- String translation  ([PR #3811](https://github.com/azure/communication-ui-library/pull/3811) by carolinecao@microsoft.com)
...
- Create Calling sounds subscriber in the call adapter to listen to different call events and play sounds accordingly ([PR #3759](https://github.com/azure/communication-ui-library/pull/3759) by 94866715+dmceachernmsft@users.noreply.github.com)
- Update rooms call end pages ([PR #3758](https://github.com/azure/communication-ui-library/pull/3758) by 79475487+mgamis-msft@users.noreply.github.com)
- Introduce sound for when a call is rejected by the callee ([PR #3805](https://github.com/azure/communication-ui-library/pull/3805) by 94866715+dmceachernmsft@users.noreply.github.com)
...
### Improvements
- Update dev dependency of chat sdk ([PR #3798](https://github.com/azure/communication-ui-library/pull/3798) by 9044372+JoshuaLai@users.noreply.github.com)
...
- merging prerelease branch back into main ([PR #3787](https://github.com/azure/communication-ui-library/pull/3787) by alkwa@microsoft.com)
...
- Add additional telemetry to userAgent that indicates either Chat Composite, Call Composite, Call with Chat composite or Stateful components.  ([PR #3481](https://github.com/azure/communication-ui-library/pull/3481) by 73612854+palatter@users.noreply.github.com)
- TDBuild - updating localized resource files. ([PR #3740](https://github.com/azure/communication-ui-library/pull/3740) by alkwa@microsoft.com)
- Update calling SDK to use latest stable and beta versions ([PR #3831](https://github.com/azure/communication-ui-library/pull/3831) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- patch updates to deps ([PR #3847](https://github.com/azure/communication-ui-library/pull/3847) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Update Calling dependency to use the latest version 1.18.1 ([PR #3738](https://github.com/azure/communication-ui-library/pull/3738) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Reduce console output noise in sample apps ([PR #3773](https://github.com/azure/communication-ui-library/pull/3773) by 2684369+JamesBurnside@users.noreply.github.com)
- Update to type-fest 3.x; tidy out some unnecessary dependencies ([PR #3895](https://github.com/azure/communication-ui-library/pull/3895) by 3941071+emlynmac@users.noreply.github.com)
...
- Add support for local screenshare streams in Calling Statful Client ([PR #3865](https://github.com/azure/communication-ui-library/pull/3865) by 2684369+JamesBurnside@users.noreply.github.com)
### Bug Fixes
...
- Stop camera when capability to turn video on is no longer present. Lower hand when role is changed to Consumer. ([PR #3820](https://github.com/azure/communication-ui-library/pull/3820) by 79475487+mgamis-msft@users.noreply.github.com)
...
- Dispose of the unparented views when we hit a state that has us actually in a call ([PR #3876](https://github.com/azure/communication-ui-library/pull/3876) by 94866715+dmceachernmsft@users.noreply.github.com)
