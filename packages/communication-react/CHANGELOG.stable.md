...
This log was last generated on Mon, 14 Aug 2023 18:28:26 GMT and should not be manually modified.
...
### Improvements
- Rearrange Image Gallery layout ([PR #3426](https://github.com/azure/communication-ui-library/pull/3426) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Fix alpha packages to have well defined beta dependencies and not leak stable deps that break builds ([PR #3418](https://github.com/azure/communication-ui-library/pull/3418) by 2684369+JamesBurnside@users.noreply.github.com)
- Add e2e tests for different themes for Image Gallery ([PR #3416](https://github.com/azure/communication-ui-library/pull/3416) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Introduce new guideline for how to make changelog entry ([PR #3435](https://github.com/azure/communication-ui-library/pull/3435) by joshlai@microsoft.com)
- Add 'shake to send logs' feature to sample apps ([PR #3425](https://github.com/azure/communication-ui-library/pull/3425) by 2684369+JamesBurnside@users.noreply.github.com)
- Fixed a script for release branch creation ([PR #3444](https://github.com/azure/communication-ui-library/pull/3444) by 98852890+vhuseinova-msft@users.noreply.github.com)
...
- Versions bump scripts update ([PR #3441](https://github.com/azure/communication-ui-library/pull/3441) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Updated documentation to reflect onSendMessage behaviour ([PR #3433](https://github.com/azure/communication-ui-library/pull/3433) by joshlai@microsoft.com)
- Updated Beachball config with new prompts ([PR #3371](https://github.com/azure/communication-ui-library/pull/3371) by joshlai@microsoft.com)
- Fetch translated strings ([PR #3431](https://github.com/azure/communication-ui-library/pull/3431) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Updating signaling sdk to 1.0.0-beta19 ([PR #3414](https://github.com/azure/communication-ui-library/pull/3414) by joshlai@microsoft.com)
### Bug Fixes
- Fixed logic of when to show display name field in Calling sample app ([PR #3407](https://github.com/azure/communication-ui-library/pull/3407) by 79475487+mgamis-msft@users.noreply.github.com)
- Fix nightly alpha releases having || in the version dependencies ([PR #3440](https://github.com/azure/communication-ui-library/pull/3440) by 2684369+JamesBurnside@users.noreply.github.com)
- Fixes issue where when local participant stops screen share their local stream would disappear but still be showing to others in the call ([PR #3419](https://github.com/azure/communication-ui-library/pull/3419) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- add role ([PR #3412](https://github.com/azure/communication-ui-library/pull/3412) by carolinecao@microsoft.com)
- Fixes side pane to refocus the people button when user closes the people pane with keyboard. ([PR #3403](https://github.com/azure/communication-ui-library/pull/3403) by 94866715+dmceachernmsft@users.noreply.github.com)
### Other Changes
- Testing dependencies update ([PR #3283](https://github.com/azure/communication-ui-library/pull/3283) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Update changelog for hot fixes ([PR #3315](https://github.com/azure/communication-ui-library/pull/3315) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Add url support for teams call ([PR #3209](https://github.com/azure/communication-ui-library/pull/3209) by jiangnanhello@live.com)
- [FileCard.test] adding new FileCard unit tests ([PR #3335](https://github.com/azure/communication-ui-library/pull/3335) by joshlai@microsoft.com)
- Update release validation for new security requirements ([PR #3195](https://github.com/azure/communication-ui-library/pull/3195) by 2684369+JamesBurnside@users.noreply.github.com)
- Intermediate fix for capabilites not being provided correctly by beta of Calling SDK (do not include this in release change log) ([PR #3401](https://github.com/azure/communication-ui-library/pull/3401) by 79475487+mgamis-msft@users.noreply.github.com)
- Remove transfer request prompt example from Transfer storybook documentation ([PR #3308](https://github.com/azure/communication-ui-library/pull/3308) by miguelgamis@microsoft.com)
- Add ImageGallery as a new UI component ([PR #3380](https://github.com/azure/communication-ui-library/pull/3380) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Get treeshaked build in production mode ([PR #3225](https://github.com/azure/communication-ui-library/pull/3225) by jiangnanhello@live.com)
- Add downloadAttachment method for adapter storbook page ([PR #3327](https://github.com/azure/communication-ui-library/pull/3327) by 77021369+jimchou-dev@users.noreply.github.com)
- Announce that you are being transferred when transfer page is showing when screenreader is on ([PR #3219](https://github.com/azure/communication-ui-library/pull/3219) by miguelgamis@microsoft.com)
- Added capabilites feature to stateful client ([PR #3340](https://github.com/azure/communication-ui-library/pull/3340) by miguelgamis@microsoft.com)
- removing feature issue type ([PR #3398](https://github.com/azure/communication-ui-library/pull/3398) by 79329532+alkwa-msft@users.noreply.github.com)
- Groom 1.6.0 changelog ([PR #3248](https://github.com/azure/communication-ui-library/pull/3248) by 41898282+github-actions[bot]@users.noreply.github.com)
- update onCancelMessageEdit to onCancelEditMessage for 1.6.0 release ([PR #3244](https://github.com/azure/communication-ui-library/pull/3244) by 2684369+JamesBurnside@users.noreply.github.com)
- Handle mention messages with angle brackets and ampersand ([PR #3226](https://github.com/azure/communication-ui-library/pull/3226) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Update updating-npm-publishing.md to include detailed steps on PAT Token generation and troubleshooting guide ([PR #3378](https://github.com/azure/communication-ui-library/pull/3378) by edwardlee@microsoft.com)
- Fix up visual artifact on MentionPopover ([PR #3186](https://github.com/azure/communication-ui-library/pull/3186) by 3941071+emlynmac@users.noreply.github.com)
- Fix cte query arg in Calling sample ([PR #3282](https://github.com/azure/communication-ui-library/pull/3282) by miguelgamis@microsoft.com)
- Fixed selection indexes for mouse click events on mention ([PR #3199](https://github.com/azure/communication-ui-library/pull/3199) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Fix icon documentation ([PR #3370](https://github.com/azure/communication-ui-library/pull/3370) by 2684369+JamesBurnside@users.noreply.github.com)
- Remove displayText parameter from mentions ([PR #3189](https://github.com/azure/communication-ui-library/pull/3189) by 3941071+emlynmac@users.noreply.github.com)
- Add breaking change checker info ([PR #3207](https://github.com/azure/communication-ui-library/pull/3207) by jiangnanhello@live.com)
- Improve Storybook Sidebar Navigation and Content Arrangement ([PR #3321](https://github.com/azure/communication-ui-library/pull/3321) by longamy@microsoft.com)
- Video effects conceptual docs in storybook ([PR #3278](https://github.com/azure/communication-ui-library/pull/3278) by 97124699+prabhjot-msft@users.noreply.github.com)
- Add public preview to file sharing and fix indentation for Bug Fixes section ([PR #3315](https://github.com/azure/communication-ui-library/pull/3315) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Fixed margins for mention send box example in Storybook ([PR #3213](https://github.com/azure/communication-ui-library/pull/3213) by 98852890+vhuseinova-msft@users.noreply.github.com)
...
- Bumped ([PR #3315](https://github.com/azure/communication-ui-library/pull/3315) by 41898282+github-actions[bot]@users.noreply.github.com)
- Still output success result when skip the check ([PR #3201](https://github.com/azure/communication-ui-library/pull/3201) by jiangnanhello@live.com)
- Fix Deploy CI Pipelines ([PR #3241](https://github.com/azure/communication-ui-library/pull/3241) by 3941071+emlynmac@users.noreply.github.com)
- Update beta version bump script ([PR #3280](https://github.com/azure/communication-ui-library/pull/3280) by miguelgamis@microsoft.com)
- Group call readiness icons together in icon list of storybook documentation  ([PR #3395](https://github.com/azure/communication-ui-library/pull/3395) by 79475487+mgamis-msft@users.noreply.github.com)
- update pnpm version to 8.6.9 ([PR #3357](https://github.com/azure/communication-ui-library/pull/3357) by 2684369+JamesBurnside@users.noreply.github.com)
- Do not show mention suggestion items with empty display text ([PR #3243](https://github.com/azure/communication-ui-library/pull/3243) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Fix home screen error of stable Calling sample ([PR #3390](https://github.com/azure/communication-ui-library/pull/3390) by 79475487+mgamis-msft@users.noreply.github.com)
...
- Maintain audio and video state by default after accepting transfer. Only showing transfer target in transfer page when their display name is known. Opacity of transfer page avatar change to 40% ([PR #3165](https://github.com/azure/communication-ui-library/pull/3165) by miguelgamis@microsoft.com)
- Rephrase file sharing storybook page ([PR #3289](https://github.com/azure/communication-ui-library/pull/3289) by 77021369+jimchou-dev@users.noreply.github.com)
- Fixed cursor position during mention editing ([PR #3242](https://github.com/azure/communication-ui-library/pull/3242) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Upgrade to rush 5.100.1 ([PR #3246](https://github.com/azure/communication-ui-library/pull/3246) by 3941071+emlynmac@users.noreply.github.com)
- Updated initial index value in findStringsDiffIndexes to include the last symbol in the strings ([PR #3215](https://github.com/azure/communication-ui-library/pull/3215) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Created conceptual docs page for transfer in storybook ([PR #3180](https://github.com/azure/communication-ui-library/pull/3180) by miguelgamis@microsoft.com)
- Fixed Storybook sendbox showing alert before clear the inputField ([PR #3238](https://github.com/azure/communication-ui-library/pull/3238) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Update Adapters storybook page to include transfer API changes ([PR #3193](https://github.com/azure/communication-ui-library/pull/3193) by miguelgamis@microsoft.com)
- Remove webpack4 dependency from storybook ([PR #3259](https://github.com/azure/communication-ui-library/pull/3259) by 3941071+emlynmac@users.noreply.github.com)
- Add tests for mouse and keyboard events when interacting with mentions in SendBox ([PR #3224](https://github.com/azure/communication-ui-library/pull/3224) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Updated description for showParticipantOverflowTooltip prop ([PR #3323](https://github.com/azure/communication-ui-library/pull/3323) by 98852890+vhuseinova-msft@users.noreply.github.com)
- fix breaking change check by ensuring dependencies are installed for the base branch ([PR #3356](https://github.com/azure/communication-ui-library/pull/3356) by 2684369+JamesBurnside@users.noreply.github.com)
- Update deploy-azure-webapps.yml to OICD ([PR #3231](https://github.com/azure/communication-ui-library/pull/3231) by 77021369+jimchou-dev@users.noreply.github.com)
- Update creating-a-release.md ([PR #3085](https://github.com/azure/communication-ui-library/pull/3085) by jiangnanhello@live.com)
- Fix up popover position within scrolled textfield ([PR #3184](https://github.com/azure/communication-ui-library/pull/3184) by 3941071+emlynmac@users.noreply.github.com)
- Fix for a Storybook issue when messages can't be sent in Message thread ([PR #3197](https://github.com/azure/communication-ui-library/pull/3197) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Fixed selection is incorrect after deletion ([PR #3240](https://github.com/azure/communication-ui-library/pull/3240) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Update 1.7.0-beta.1 changelog with adhoc feature description ([PR #3315](https://github.com/azure/communication-ui-library/pull/3315) by miguelgamis@microsoft.com)
- Use more specific messages for endcall page when adhoc calling fails ([PR #3247](https://github.com/azure/communication-ui-library/pull/3247) by miguelgamis@microsoft.com)
- Add adhoc calling conceptual docs page to storybook ([PR #3236](https://github.com/azure/communication-ui-library/pull/3236) by 79475487+mgamis-msft@users.noreply.github.com)
...
- Update VideoGallery storybook page to correct some errors ([PR #3318](https://github.com/azure/communication-ui-library/pull/3318) by 94866715+dmceachernmsft@users.noreply.github.com)
- Add azure deployment failure to the pipeline ([PR #3265](https://github.com/azure/communication-ui-library/pull/3265) by 97124699+prabhjot-msft@users.noreply.github.com)
- Point readme instructions to install non-fixed versions of peer deps ([PR #3232](https://github.com/azure/communication-ui-library/pull/3232) by 2684369+JamesBurnside@users.noreply.github.com)
- Ensure user switches to newly accepted transfer call when it is in the connected state and hang up the old call ([PR #3228](https://github.com/azure/communication-ui-library/pull/3228) by miguelgamis@microsoft.com)
- Fix mention popover position is far up in long text ([PR #3250](https://github.com/azure/communication-ui-library/pull/3250) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Adding Feature request through Microsoft QNA template ([PR #3396](https://github.com/azure/communication-ui-library/pull/3396) by 79329532+alkwa-msft@users.noreply.github.com)
- Updated mouse selections and clicks handling behaviour for mentions ([PR #3187](https://github.com/azure/communication-ui-library/pull/3187) by 98852890+vhuseinova-msft@users.noreply.github.com)
...
- If video effect fails, none effect in picker is highlighted ([PR #3334](https://github.com/azure/communication-ui-library/pull/3334) by 97124699+prabhjot-msft@users.noreply.github.com)
...
- Add Raise hand feature to the UI library ([PR #3269](https://github.com/azure/communication-ui-library/pull/3269) by ruslanzdor@microsoft.com)
...
- remove wrong log ([PR #3267](https://github.com/azure/communication-ui-library/pull/3267) by ruslanzdor@microsoft.com)
...
- Add support for depencdency isolation for video background effects (Treeshaking + Lazy loading) ([PR #3352](https://github.com/azure/communication-ui-library/pull/3352) by 97124699+prabhjot-msft@users.noreply.github.com)
- beta version bump ([PR #3315](https://github.com/azure/communication-ui-library/pull/3315) by joshlai@microsoft.com)
...
- add ovc to storybook ([PR #3363](https://github.com/azure/communication-ui-library/pull/3363) by carolinecao@microsoft.com)
...
- Removes the role hint and permissions provider from the CallAdapter state allowing for simpler use of the CallComposite with a rooms call ([PR #3360](https://github.com/azure/communication-ui-library/pull/3360) by 94866715+dmceachernmsft@users.noreply.github.com)
