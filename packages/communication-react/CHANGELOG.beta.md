...
## [1.5.1-beta.1](https://github.com/azure/communication-ui-library/tree/@azure/communication-react_v1.5.1-beta.1)

Wed, 01 Feb 2023 17:56:59 GMT 
[Compare changes](https://github.com/azure/communication-ui-library/compare/@azure/communication-react_v1.5.0...@azure/communication-react_v1.5.1-beta.1)
...
- `@azure/communication-react`
  ...
  - Fix issue where local video would be not showing to the user whilst it was broadcasting to everyone else on the call. This happened in a race condition if the local video tile unmounted and remounted in quick succession multiple times. ([PR #2558](https://github.com/azure/communication-ui-library/pull/2558) by 2684369+JamesBurnside@users.noreply.github.com)
...
- `@azure/communication-react`
  ...
  - Disabling pin menu button on remote VideoTile of VideoGallery when max pinned remote video tiles is reached ([commit](https://github.com/azure/communication-ui-library/commit/not available) by miguelgamis@microsoft.com)
