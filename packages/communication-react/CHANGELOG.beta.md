...
This log was last generated on Tue, 30 Jan 2024 19:19:15 GMT and should not be manually modified.

<!-- Start content -->

## [1.13.0-beta.1](https://github.com/azure/communication-ui-library/tree/@azure/communication-react_v1.13.0-beta.1)

Tue, 30 Jan 2024 19:19:15 GMT 
[Compare changes](https://github.com/azure/communication-ui-library/compare/@azure/communication-react_v1.12.0...@azure/communication-react_v1.13.0-beta.1)

### Features
- Add dtmf tone sound generation to dialpad component ([PR #3959](https://github.com/azure/communication-ui-library/pull/3959) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Tag survey component ([PR #3533](https://github.com/azure/communication-ui-library/pull/3533) by 96077406+carocao-msft@users.noreply.github.com)
- add callback for survey dismissed to selfhost ([PR #4009](https://github.com/azure/communication-ui-library/pull/4009) by 96077406+carocao-msft@users.noreply.github.com)
- UI updates and free form text survey ([PR #3923](https://github.com/azure/communication-ui-library/pull/3923) by 96077406+carocao-msft@users.noreply.github.com)
- Change hideSurvey to disableSurvey ([PR #4006](https://github.com/azure/communication-ui-library/pull/4006) by 96077406+carocao-msft@users.noreply.github.com)
...
- Add API to disable sounds for a silent experience ([PR #3961](https://github.com/azure/communication-ui-library/pull/3961) by 94866715+dmceachernmsft@users.noreply.github.com)
- Update Dialpad styles per designs ([PR #3999](https://github.com/azure/communication-ui-library/pull/3999) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- ui change ([PR #3951](https://github.com/azure/communication-ui-library/pull/3951) by 96077406+carocao-msft@users.noreply.github.com)
- Introduce new end call screen when callee is busy ([PR #3807](https://github.com/azure/communication-ui-library/pull/3807) by 94866715+dmceachernmsft@users.noreply.github.com)
- ccc ([PR #3815](https://github.com/azure/communication-ui-library/pull/3815) by carolinecao@microsoft.com)
...
- Flatten API so that we can introduce chat sounds in a similar way in the future on the chat adapter ([PR #3822](https://github.com/azure/communication-ui-library/pull/3822) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Introduce new CallAdapter state to store the callee of a outbound call ([PR #3822](https://github.com/azure/communication-ui-library/pull/3822) by 94866715+dmceachernmsft@users.noreply.github.com)
- Introduce storybook documentation about calling sounds and how to use them ([PR #3813](https://github.com/azure/communication-ui-library/pull/3813) by 94866715+dmceachernmsft@users.noreply.github.com)
- star survey ([PR #3533](https://github.com/azure/communication-ui-library/pull/3533) by carolinecao@microsoft.com)
...
- update config to include sounds in the deploy ([PR #3824](https://github.com/azure/communication-ui-library/pull/3824) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Reaction Resource API implementation ([PR #4054](https://github.com/azure/communication-ui-library/pull/4054) by mbellah@microsoft.com)
- Send reaction button component ([PR #4003](https://github.com/azure/communication-ui-library/pull/4003) by mbellah@microsoft.com)
...
- Communication react update ([PR #3814](https://github.com/azure/communication-ui-library/pull/3814) by mbellah@microsoft.com)
- React-Component update ([PR #3814](https://github.com/azure/communication-ui-library/pull/3814) by mbellah@microsoft.com)
- Send reaction button component ([PR #3997](https://github.com/azure/communication-ui-library/pull/3997) by mbellah@microsoft.com)
### Improvements
- Update min node version in storybook ([PR #3950](https://github.com/azure/communication-ui-library/pull/3950) by 73612854+palatter@users.noreply.github.com)
...
- Refresh token in sample due to token being to large to pass through request parameters ([PR #3848](https://github.com/azure/communication-ui-library/pull/3848) by palatter@microsoft.com)
- new beta release ([PR #3837](https://github.com/azure/communication-ui-library/pull/3837) by 96077406+carocao-msft@users.noreply.github.com)
...
- Update rush/pnpm ([PR #3851](https://github.com/azure/communication-ui-library/pull/3851) by 3941071+emlynmac@users.noreply.github.com)
...
- Chrome version update ([PR #3931](https://github.com/azure/communication-ui-library/pull/3931) by 98852890+vhuseinova-msft@users.noreply.github.com)
...
- Make Calling Sample textfield validate the Teams user id format ([PR #3967](https://github.com/azure/communication-ui-library/pull/3967) by 2684369+JamesBurnside@users.noreply.github.com)
- add storybook documentation about custom branding in more places ([PR #3839](https://github.com/azure/communication-ui-library/pull/3839) by 2684369+JamesBurnside@users.noreply.github.com)
...
- Introduce new snippets in the error handling concepts to explicitely show how to interact with errors in the stateful client and adapters ([PR #3843](https://github.com/azure/communication-ui-library/pull/3843) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Add internal storybook page and a feature flag for Rich Text Editor feature ([PR #3973](https://github.com/azure/communication-ui-library/pull/3973) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Update storybook docs removing old beta banners for ga's features. General doc improvements ([PR #3835](https://github.com/azure/communication-ui-library/pull/3835) by 94866715+dmceachernmsft@users.noreply.github.com)
...
- Groom stable changelog ([PR #3920](https://github.com/azure/communication-ui-library/pull/3920) by miguelgamis@microsoft.com)
...
- Improve cleanup in the rush generate-api-diff command and add GitHub action ([PR #3947](https://github.com/azure/communication-ui-library/pull/3947) by 2684369+JamesBurnside@users.noreply.github.com)
- Pin chrome to 119 for UI tests ([PR #3916](https://github.com/azure/communication-ui-library/pull/3916) by 2684369+JamesBurnside@users.noreply.github.com)
...
- Rush update ([PR #3935](https://github.com/azure/communication-ui-library/pull/3935) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Bump GitHub workflows to node v20 ([PR #3856](https://github.com/azure/communication-ui-library/pull/3856) by 3941071+emlynmac@users.noreply.github.com)
- Remove Inline Image from stable ([PR #4010](https://github.com/azure/communication-ui-library/pull/4010) by 107075081+Leah-Xia-Microsoft@users.noreply.github.com)
- Add required field to sample textfields ([PR #3869](https://github.com/azure/communication-ui-library/pull/3869) by 2684369+JamesBurnside@users.noreply.github.com)
...
- Update Rooms page in storybook ([PR #3832](https://github.com/azure/communication-ui-library/pull/3832) by miguelgamis@microsoft.com)
...
- Script to autogenerate api diffs ([PR #3799](https://github.com/azure/communication-ui-library/pull/3799) by 2684369+JamesBurnside@users.noreply.github.com)
...
### Bug Fixes
- Fix up noImplicitAny for Chat Composites ([PR #3987](https://github.com/azure/communication-ui-library/pull/3987) by 3941071+emlynmac@users.noreply.github.com)
...
- Resolve resource not found error for inline image placeholder UITest ([PR #3979](https://github.com/azure/communication-ui-library/pull/3979) by 73612854+palatter@users.noreply.github.com)
...
- Fix up Chat sample for noImplicitAny ([PR #4000](https://github.com/azure/communication-ui-library/pull/4000) by 3941071+emlynmac@users.noreply.github.com)
...
- Samples should not show copy invite link on pstn calls ([PR #3868](https://github.com/azure/communication-ui-library/pull/3868) by 2684369+JamesBurnside@users.noreply.github.com)
- Update deps for ts-node and friends for samples ([PR #3873](https://github.com/azure/communication-ui-library/pull/3873) by 3941071+emlynmac@users.noreply.github.com)
- Hide screenshare button in Calling and CallWithChat samples when on iOS ([PR #3864](https://github.com/azure/communication-ui-library/pull/3864) by 79475487+mgamis-msft@users.noreply.github.com)
...
- Fix for an issue when file types icons weren't available for storybook ([PR #3928](https://github.com/azure/communication-ui-library/pull/3928) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Fix for legal alerts for internal sample packages and packages for testing ([PR #4072](https://github.com/azure/communication-ui-library/pull/4072) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Fix internal stories not showing in storybook ([PR #3903](https://github.com/azure/communication-ui-library/pull/3903) by 2684369+JamesBurnside@users.noreply.github.com)
- Fix sample appl issue where after selecting pstn call then switching to start group call, the calls fails trying to make a PSTN call ([PR #3962](https://github.com/azure/communication-ui-library/pull/3962) by 2684369+JamesBurnside@users.noreply.github.com)
...
- Updated UsePropsFor story ([PR #3934](https://github.com/azure/communication-ui-library/pull/3934) by 98852890+vhuseinova-msft@users.noreply.github.com)
