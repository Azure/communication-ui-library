...
### Features
- Made Custom Branding Composite options available in beta builds ([PR #3802](https://github.com/azure/communication-ui-library/pull/3802) by 2684369+JamesBurnside@users.noreply.github.com)
...
### Improvements
- Improved how background and logo are applied in the Call Composites ([PR #3741](https://github.com/azure/communication-ui-library/pull/3741) by 2684369+JamesBurnside@users.noreply.github.com)
- Removed isRoomsCall from CallWithChatAdapterState ([PR #3800](https://github.com/azure/communication-ui-library/pull/3800) by 79475487+mgamis-msft@users.noreply.github.com)
- Updated rooms call end pages UI including icons and strings ([PR #3758](https://github.com/azure/communication-ui-library/pull/3758) by 79475487+mgamis-msft@users.noreply.github.com)
- Updated CTE sdk ref ([PR #3610](https://github.com/azure/communication-ui-library/pull/3610) by jiangnanhello@live.com)
- Changed display name for remote participants as Attendee if hide attendee name is on ([PR #3719](https://github.com/azure/communication-ui-library/pull/3719) by 97124699+prabhjot-msft@users.noreply.github.com)
- Updated dev dependency of chat sdk ([PR #3798](https://github.com/azure/communication-ui-library/pull/3798) by 9044372+JoshuaLai@users.noreply.github.com)
- Updated @azure/communication-chat peerDependency to match devDependency ([PR #3774](https://github.com/azure/communication-ui-library/pull/3774) by 73612854+palatter@users.noreply.github.com)
- Updated the API for onUpdateMessage, moved metadata into options bag ([PR #3760](https://github.com/azure/communication-ui-library/pull/3760) by 9044372+JoshuaLai@users.noreply.github.com)
- Simplified types use in the RemoteParticipantstate by collapsing other identifiers to just CommunicationIdentifierKind ([PR #3761](https://github.com/azure/communication-ui-library/pull/3761) by alkwa@microsoft.com)
- Updated Calling dependency to use the latest version 1.18.1 for stable and 1.19.1-beta.2 for beta ([PR #3738](https://github.com/azure/communication-ui-library/pull/3738) and [PR #3732](https://github.com/azure/communication-ui-library/pull/3732) by 94866715+dmceachernmsft@users.noreply.github.com)
- Updated Custom Button Injection Storybook ([PR #3729](https://github.com/azure/communication-ui-library/pull/3729) by edwardlee@microsoft.com)
- Updated and improve docs, fixed typos and improved readability ([PR #3716](https://github.com/azure/communication-ui-library/pull/3716) by 2684369+JamesBurnside@users.noreply.github.com) ([PR #3718](https://github.com/azure/communication-ui-library/pull/3718) by 2684369+JamesBurnside@users.noreply.github.com)
- Reduced console output noise in sample apps ([PR #3773](https://github.com/azure/communication-ui-library/pull/3773) by 2684369+JamesBurnside@users.noreply.github.com)
- Updated CCC to Conditional Compilation doc ([PR #3134](https://github.com/azure/communication-ui-library/pull/3134) by jiangnanhello@live.com)
### Bug Fixes
- Fixed pathing for nightly-cd ([PR #3711](https://github.com/azure/communication-ui-library/pull/3711) by 79329532+alkwa-msft@users.noreply.github.com)
- Fixed the usage of the cleanup script to remove unnecessary properties in the communication-react package.json ([PR #3702](https://github.com/azure/communication-ui-library/pull/3702) by alkwa@microsoft.com)
- Fixed lobby page text using incorrect theme token value. ([PR #3797](https://github.com/azure/communication-ui-library/pull/3797) by 2684369+JamesBurnside@users.noreply.github.com)
- Hid raised hand button for consumer in rooms call ([PR #3723](https://github.com/azure/communication-ui-library/pull/3723) by 79475487+mgamis-msft@users.noreply.github.com)
- Added handlers for Enter and Space keys for message menu button ([PR #3755](https://github.com/azure/communication-ui-library/pull/3755) by 98852890+vhuseinova-msft@users.noreply.github.com)
- Fixed local video stream rendering when camera is turned on while screensharing is active ([PR #3779](https://github.com/azure/communication-ui-library/pull/3779) by 79475487+mgamis-msft@users.noreply.github.com)
- Added ability to start captions on mobile with keyboard with toggle on toplevel menu item and not secondary component ([PR #3801](https://github.com/azure/communication-ui-library/pull/3801) by 94866715+dmceachernmsft@users.noreply.github.com)
- Rendered gallery content only when people pane screens on mobile aren't present ([PR #3754](https://github.com/azure/communication-ui-library/pull/3754) by 94866715+dmceachernmsft@users.noreply.github.com)
- Prevented possible endless loop of switching between scrollable and paginated horizontal gallery in VideoGallery ([PR #3730](https://github.com/azure/communication-ui-library/pull/3730) by 79475487+mgamis-msft@users.noreply.github.com)
