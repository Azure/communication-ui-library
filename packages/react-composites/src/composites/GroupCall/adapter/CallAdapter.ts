...
export interface CallAdapter {
  ...
  on(event: 'isScreenSharingActiveChanged', participantsJoinedHandler: IsScreenSharingOnChangedListener): void;
  ...
  off(event: 'isScreenSharingActiveChanged', participantsJoinedHandler: IsScreenSharingOnChangedListener): void;
