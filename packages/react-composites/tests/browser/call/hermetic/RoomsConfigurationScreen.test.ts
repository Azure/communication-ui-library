...
test.describe('Rooms Call Configuration Screen Tests for different roles', () => {
  test.only('All configurations are enabled for Presenter', async ({ page, serverUrl }) => {
  ...
  test.only('All configurations are enabled for Attendee', async ({ page, serverUrl }) => {
  ...
  test.only('Only configurations for speaker are enabled for Consumer', async ({ page, serverUrl }) => {
