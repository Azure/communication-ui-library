...
export const IDS = {
  ...
  overflowGalleryLeftNavButton: 'horizontal-gallery-left-nav-button',
  overflowGalleryRightNavButton: 'horizontal-gallery-right-nav-button',
  ...
  verticalGalleryLeftNavButton: 'overflow-gallery-left-nav-button',
  verticalGalleryRightNavButton: 'overflow-gallery-right-nav-button',
