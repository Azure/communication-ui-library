...
/**
 * Wait for the Call-And-Chat Composite on a page to fully load.
 */
export const waitForCallAndChatCompositeToLoad = async (page: Page): Promise<void> => {
  // CallAndChat composite initial page is the same as call composite
...
export const buildUrl = (
  serverUrl: string,
  user: ChatUserType | CallUserType | CallAndChatUserType,
