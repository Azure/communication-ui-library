...
test('works', () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      unlink,
      paths: [ENTRY]
    } = yield test_support_1.writeFiles({
...
test('works with SafeBuffer and other package consumers', () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      ...
      'safe-buffer.ts': fs_1.default.readFileSync(require.resolve('safe-buffer')).toString()
    });
    // const outfile = randomOutputFile()
    const res = yield esbuild_1.build({
      entryPoints: [ENTRY],
...
test('does not include global keyword', () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      unlink,
      paths: [ENTRY]
