...
const mapAliasColors = (palette: IPalette, inverted: boolean): ColorTokens => {
  return {
    ...
    colorNeutralForeground5Hover: palette.neutralQuaternary,
    colorNeutralForeground5Pressed: palette.neutralQuaternary,
    ...
    colorNeutralBackground7: palette.neutralLight,
    colorNeutralBackground7Hover: palette.neutralLight,
    colorNeutralBackground7Pressed: palette.neutralLight,
    colorNeutralBackground7Selected: palette.neutralLight,
    colorNeutralBackground8: palette.neutralLight,
    colorNeutralBackgroundStatic: grey[20],
    colorNeutralBackgroundInverted: palette.neutralSecondary,
    colorNeutralBackgroundInvertedHover: palette.neutralSecondary,
    colorNeutralBackgroundInvertedPressed: palette.neutralSecondary,
    colorNeutralBackgroundInvertedSelected: palette.neutralSecondary,
    ...
    colorNeutralBackgroundDisabled2: palette.neutralLighter,
    ...
    colorNeutralStroke4: palette.neutralLighter,
    colorNeutralStroke4Hover: palette.neutralLighter,
    colorNeutralStroke4Pressed: palette.neutralLighter,
    colorNeutralStroke4Selected: palette.neutralLighter,
    ...
    colorNeutralStrokeDisabled2: palette.neutralQuaternaryAlt,
