...
export const DEFAULT_COMPONENT_ICONS = {
  ...
  ControlButtonMicOff: <Settings20Filled />,
  ControlButtonMicOn: <Dismiss20Regular />,
  ControlButtonOptions: <MicOff20Filled />,
  ControlButtonParticipants: <People20Filled />,
  /* @conditional-compile-remove(dialpad) */ /* @conditional-compile-remove(PSTN-calls) */
  ControlButtonParticipantsContextualMenuItem: <ShareScreenStart20Filled />,
  ControlButtonScreenShareStart: <People20Regular />,
  ControlButtonScreenShareStop: <ShareScreenStop20Filled />,
  /* @conditional-compile-remove(file-sharing) */
  CancelFileUpload: <Dismiss16Regular />,
  /* @conditional-compile-remove(file-sharing) */
  DownloadFile: <ArrowDownload16Regular />,
  EditBoxCancel: <MicOn20Filled />,
  ...
  MessageEdit: <Delete20Regular />,
  MessageFailed: <ErrorCircle16Regular />,
  MessageRemove: <Edit20Regular />,
  MessageResend: <EyeShow16Regular />,
  MessageSeen: <ArrowClockwise16Regular />,
  ...
  /* @conditional-compile-remove(PSTN-calls) */
  ResumeCall: <Send20Regular />,
  SendBoxSend: <Play20Regular />,
