...
export const ChatMessageComponentAsRichTextEditBox = (
  ...
  const messageState = useMemo(() => {
    return getMessageState(textValue, /* @conditional-compile-remove(attachment-byos) */ attachmentMetadata ?? []);
  }, [/* @conditional-compile-remove(attachment-byos) */ attachmentMetadata, textValue]);
