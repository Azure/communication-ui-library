...
import type { IEditor, TableFormat } from 'roosterjs-editor-types-compatible';
 ...
 */
export const insertTable = (editor: IEditor, columns: number, rows: number, format?: TableFormat): void => {
  ...
  editor.addUndoSnapshot(
    () => {
      ...
      //TODO: add styles inside the div but not for the editor (outer one!!!)
