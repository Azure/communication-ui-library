...
export const VideoGallery = (props: VideoGalleryProps): JSX.Element => {
  ...
  const canStartTogetherMode = _isIdentityMicrosoftTeamsUser(localParticipant.userId) && startTogetherModeEnabled;
  ...
  const videoGalleryLayout = useMemo(() => {
    ...
    if (layout === 'togetherMode' && (canStartTogetherMode || isTogetherModeActive)) {
      return <TogetherModeLayout {...layoutProps} />;
    }
    return <DefaultLayout {...layoutProps} />;
  }, [canStartTogetherMode, isTogetherModeActive, layout, layoutProps, screenShareParticipant]);
