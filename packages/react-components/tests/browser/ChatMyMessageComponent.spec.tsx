...
betaTest.describe('ChatMyMessageComponent rich text editor attachment tests', () => {
  ...
  betaTest('Edit box should not allow to save empty text when attachments are deleted', async ({ mount, page }, testInfo) => {
...
betaTest.describe('ChatMyMessageComponent text editor attachment tests', () => {
  ...
  betaTest('Edit box should allow to save empty html text when attachments are deleted', async ({ mount, page }, testInfo) => {
