...
export type CallErrorTarget =
  ...
  | 'Call.unmute'
  | 'CallAgent.dispose'
  | /* @conditional-compile-remove-from(stable) @azure/communication-calling1.4.1-beta.1 sdk updates */ 'CallAgent.feature'
  | 'CallAgent.join'
  | 'CallAgent.off'
  | 'CallAgent.on'
  | 'CallAgent.startCall'
  | 'CallClient.createCallAgent'
  | /* @conditional-compile-remove-from(stable) @azure/communication-calling1.4.1-beta.1 sdk updates */ 'CallClient.feature'
