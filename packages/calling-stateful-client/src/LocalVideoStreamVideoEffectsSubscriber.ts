...
export class LocalVideoStreamVideoEffectsSubscriber {
  ...
  private _localVideoSteamEffectsAPI: VideoEffectsFeature;
  ...
  constructor(args: {
    ...
    context: CallContext;
    localVideoSteam: LocalVideoStreamState;
    localVideoSteamEffectsAPI: VideoEffectsFeature;
  }) {
    this._parent = args.parent;
    this._context = args.context;
    this._localVideoStream = args.localVideoSteam;
    this._localVideoSteamEffectsAPI = args.localVideoSteamEffectsAPI;

    this.subscribe();
  }

  private subscribe = (): void => {
    this._localVideoSteamEffectsAPI.on('effectsStarted', this.effectsStarted);
    this._localVideoSteamEffectsAPI.on('effectsStopped', this.effectsStopped);
    this._localVideoSteamEffectsAPI.on('effectsError', this.effectsError);
  };

  public unsubscribe = (): void => {
    this._localVideoSteamEffectsAPI.off('effectsStarted', this.effectsStarted);
    this._localVideoSteamEffectsAPI.off('effectsStopped', this.effectsStopped);
    this._localVideoSteamEffectsAPI.off('effectsError', this.effectsError);
  };
