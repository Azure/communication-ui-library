...
// @public
export type TeamsCallingHandlers = CallingHandlersCommon;
...
// @public
export const useCallingHandlers: <PropsT>(component: (props: PropsT) => ReactElement | null) => Common<CallingHandlersCommon, PropsT> | undefined;
