...
import { Call, CallAgent, LocalVideoStream, TeamsCall, TeamsCallAgent } from '@azure/communication-calling';
...
import { CallingHandlersCommon } from './createHandlersCommon';
import { createDefaultACSCallingHandlers } from './createACSCallHandlers';
...
export const createDefaultCallingHandlers = memoizeOne(
  <AgentType extends TeamsCallAgent | CallAgent = CallAgent>(
