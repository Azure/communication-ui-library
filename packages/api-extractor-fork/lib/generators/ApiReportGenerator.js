    ...
    switch (span.kind) {
      ...
      case ts.SyntaxKind.VariableDeclaration:
        if (!span.parent) {
          ...
          const listPrefix = list.getSourceFile().text.substring(list.getStart(), list.declarations[0].getStart());
      ...
      case ts.SyntaxKind.ImportType:
        DtsEmitHelpers_1.DtsEmitHelpers.modifyImportTypeSpan(
          collector,
          span,
          astDeclaration,
      ...
      for (const child of span.children) {
        ...
        if (AstDeclaration_1.AstDeclaration.isSupportedSyntaxKind(child.kind)) {
          ...
          if (sortChildren) {
            ...
            child.modification.sortKey = Collector_1.Collector.getSortKeyIgnoringUnderscore(
          ...
          if (!insideTypeLiteral) {
            ...
            const aedocSynopsis = ApiReportGenerator._getAedocSynopsis(
              collector,
              childAstDeclaration,
              messagesToReport
            );
