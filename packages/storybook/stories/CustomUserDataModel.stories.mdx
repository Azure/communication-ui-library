...
| [VideoGallery](/?path=/story/ui-components-video-gallery--video-gallery)           | onRenderRemoteVideoTile and onRenderLocalVideoTile | onRenderAvatar |
...
| [ChatComposite](/?path=/story/composites-chatcomposite--basic-example) | [displayName](/?path=/docs/composites-chat--basic-canvas#custom-data-model) | [onRenderAvatar](/?path=/docs/composites-chat--basic-canvas#custom-data-model) |
