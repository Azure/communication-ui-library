...
| ------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| [Call](/?path=/story/composites-group-call--group-call) | displayName                                                                 | onRenderAvatar                                                                 |
| [Chat](/?path=/story/composites-group-chat--group-chat) | [displayName](/?path=/docs/composites-chat--basic-canvas#custom-data-model) | [onRenderAvatar](/?path=/docs/composites-chat--basic-canvas#custom-data-model) |
