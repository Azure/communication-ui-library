...
| ------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [CallComposite](/?path=/story/composites-call--basic-example) | displayName                                                                  | onRenderAvatar                                                                  |
| [ChatComposite](/?path=/story/composites-chat--basic-example) | [displayName](/?path=/docs/composites-chat--basic-example#custom-data-model) | [onRenderAvatar](/?path=/docs/composites-chat--basic-example#custom-data-model) |
