...
<Meta
  id="customuserdatamodel"
  title="Concepts/Custom User Data Model"
...
Composites support user data model injection for display name and avatar across `CallComposite` and `ChatComposite`.

| Composite                                                                   | Display Name                                                              | Avatar                                                                                                      |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [CallComposite](./?path=/story/composites-call-basicexample--basic-example) | [displayName](./?path=/story/composites-call-basicexample--basic-example) | [onFetchAvatarPersonaData](./?path=/docs/composites-call-customdatamodelexample--custom-data-model-example) |
| [ChatComposite](./?path=/story/composites-chat-basicexample--basic-example) | [displayName](./?path=/story/composites-chat-basicexample--basic-example) | [onFetchAvatarPersonaData](./?path=/docs/composites-chat-customdatamodelexample--custom-data-model-example) |
