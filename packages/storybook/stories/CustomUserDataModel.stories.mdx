...
| ------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [CallComposite](/?path=/story/composites-call--basic-example) | [displayName](./?path=/story/composites-call-basicexample--basic-example) | [onFetchAvatarPersonaData](./?path=/docs/composites-call-customdatamodelexample--custom-data-model-example) |
| [ChatComposite](/?path=/story/composites-chat--basic-example) | [displayName](./?path=/story/composites-chat-basicexample--basic-example) | [onFetchAvatarPersonaData](./?path=/docs/composites-chat-customdatamodelexample--custom-data-model-example) |
