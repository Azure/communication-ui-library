...
to learn more about breakout rooms in Teams meetings and how to create and manage them in Teams as a Teams user.
...
changes needed to do so, we will build off this [quickstart sample](https://github.com/Azure/communication-ui-library/commit/1c0d63c9ce885263d861d6fa49cd9d0d2469ac7d)
that shows a simple calling app that joins a Teams meeting. The 4 following steps will guide you through the changes
that will be applied to two files: `App.tsx` and `CallingComponents.tsx`.
...
Github commit: https://github.com/Azure/communication-ui-library/commit/70a2a829c07c78dfe532cb687d86998004874c47
...
Github commit: https://github.com/Azure/communication-ui-library/commit/0c3bba32046ce5dffedc26b7885d792d8eb2dffd
...
Github commit: https://github.com/Azure/communication-ui-library/commit/d079cbdf61c60133ec5f7ae082b2b1db3ddc229e
...
Github commit: https://github.com/Azure/communication-ui-library/commit/473d60c50dc5c2951bd0560617097829a0131c23

## Difference in experience in Teams vs ACS Web UI library

The following list details the differences in breakout rooms experience in Teams vs ACS Web UI Library. These may
change due to design changes and customer feedback.

1. The ACS user will stay on hold in the main meeting while they are in their breakout room and will resume once
   they leave the breakout room. Alternatively, a Teams user will leave the main meeting when they join a breakout
   room.
2. When the breakout room is set to automatically move people to breakout rooms, the ACS user will be moved to
   their breakout in 5 seconds as opposed to 10 seconds for Teams users.
3. When the breakout room is closed, ACS users will not get a notification that their breakout room has closed
   and will immediately resume their main meeting. In Teams, there is a notification that the breakout room has
