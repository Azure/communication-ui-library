...
import { GroupChat } from '@azure/react-components';
import React from 'react';

const importStatement = `import { GroupChat } from '@azure/react-components';`;
const usageCode = `import { GroupChat } from '@azure/react-components';
