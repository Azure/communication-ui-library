...
Enable this feature to listen to the end users and improve calling experience. Results from end of call survey is also very helpful for Azure Communication Services to diagnose potential calling issues and improve overall calling experience.
...
The UI Library enables users to display surveys at end of call by providing the option to use end of call survey within the CallComposite and CallWithChatComposite experience.
End of Call Survey can be enabled both in Mobile Web sessions and in Desktop Web sessions.
End of Call Survey is enabled by default and is automatically included within the CallComposite and CallWithChatComposite experience.
