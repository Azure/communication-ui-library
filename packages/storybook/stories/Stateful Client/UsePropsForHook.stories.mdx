...
To see a full end-to-end example using usePropsFor, see Getting Started with [Call Stateful Client](./?path=/docs/quickstarts-statefulcallclient--page) or [Chat Stateful Client](./?path=/docs/quickstarts-statefulchatclient--page).
