...
To make it simpler to connect the stateful client with UI Components, the UI Library exposes helpers to generate props in the form of selectors and handlers.
