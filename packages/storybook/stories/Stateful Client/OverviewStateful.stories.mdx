...
const chatThreadClient = await statefulChatClient.createChatThread({ topic: '' });
```
...
[Chat Overview](https://docs.microsoft.com/azure/communication-services/concepts/chat/sdk-features). For the reference of the interfaces, see [StatefulCallClient interface](https://docs.microsoft.com/javascript/api/@azure/communication-react/statefulcallclient) and
[StatefulChatClient interface](https://docs.microsoft.com/javascript/api/@azure/communication-react/statefulchatclient).
