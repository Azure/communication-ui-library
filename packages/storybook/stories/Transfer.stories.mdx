...
<MessageBar>
  Note: Teams user ids need to have prefix '8:orgid:' when used in the CallParticipantsLocator. For example,
...
changing `afterCallAdapterCreate` callback from the above snippet to the code snippet below.
