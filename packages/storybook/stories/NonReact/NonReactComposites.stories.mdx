...
```tsx
const chatAdapter = await chatComposite.loadChatComposite( //The for composite which allows you control composite externally,
...
```tsx
const callAdapter = await callComposite.loadChatComposite( //The for composite which allows you control composite externally,
