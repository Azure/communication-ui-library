...
<Meta id="use-composite-in-non-react-environment" title="Composites/UUsing Composites in a non-react environment" />
...
Browse to http://localhost:3000 and start your journey\*
