...
# Use composites directly on your website
...
Why you want to use our bundled script experience:
...
## Using Composites in html

The first step is to import the correct bundle(s) onto your website
...
After importing chat/calling composite bundle, you are able to load composites using `chatComposite.loadChatComposite` and `callComposite.loadCallComposite`.
...
### Snippet to load the chat composite
...
### Snippet to load the call composite
...
_[Call Composite Basic Example](./?path=/docs/composites-call-basicexample--basic-example) for details on what additional properties you can apply to the call composite_
...
If you want to see these examples in Github [Examples](https://github.com/Azure/communication-ui-library/blob/PublicPreview/1.0.0-beta.3/samples/StaticHtmlComposites/index.html)
...
To learn more about the [meta tag](https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML#specifying_your_documents_character_encoding)
