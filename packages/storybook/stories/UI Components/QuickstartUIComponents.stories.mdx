...
import CallingComponentsText from '!!raw-loader!./snippets/CallingComponents.snippet.tsx';
import { CallingComponents } from './snippets/CallingComponents.snippet';
import ChatComponentsText from '!!raw-loader!./snippets/ChatComponents.snippet.tsx';
import { ChatComponents } from './snippets/ChatComponents.snippet';
...
<Meta title={`${COMPONENT_FOLDER_PREFIX}/Get started with UI Components`} />
...
| [MessageThread](/?path=/story/ui-components-messagethread--message-thread-component) | Base component that renders a chat thread with typing indicators, read receipts, etc.    |
| [SendBox](/?path=/story/ui-components-sendbox--send-box-component)                   | Base component that allows user to input messages that will be sent to the joined thread |
