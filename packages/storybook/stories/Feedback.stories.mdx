...
If there is a feature or bug you find and you are intersted in contributing directly to our code base please refer to our [contribution guide](https://github.com/Azure/communication-ui-sdk/blob/main/docs/contributing-guide/1.%20getting-set-up.md).
We encourage developers to feel welcomed into the code base and directly contribute.

## GitHub Issues

File feature requests, bugs or other issues against the [UI Library GitHub Repo](https://github.com/Azure/communication-ui-sdk/issues).
