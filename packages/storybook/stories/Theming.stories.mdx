...
The import `darkTheme` is a [Theme](https://aka.ms/fluentui#/controls/web/references/theme) object from
Fluent UI.
...
The imports `lightTheme` and `darkTheme` are available from `@azure/communication-react`. But if you wish to use your own theme,
we strongly advise using Microsoft's [Fluent UI Theme Designer](https://aka.ms/themedesigner) to create your theme. Please ensure
