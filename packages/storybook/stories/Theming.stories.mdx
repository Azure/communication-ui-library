...
With the CallComposite and CallWithChatCompsite you can also inject your own custom branding.
...
For usage details and image recommedations please refer to the [Composites](./?path=/docs/composites-call-with-chat-basicexample--basic-example#custom-branding) section.
