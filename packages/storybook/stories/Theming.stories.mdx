...
To use the FluentThemeProvider, simply import it from `@azure/react-components` and wrap it around
...
To illustrate how another theme can be applied, import `darkTheme` from `@azure/react-components`
