  ...
  return (
    <>
      ...
      <Description>
        ...
        enabling file sharing with Azure Blob Storage as your choice of a storage solution, refer to our [tutorial](https://docs.microsoft.com/azure/communication-services/tutorials/file-sharing-tutorial).
        
        File sharing is not supported for Teams interop scenarios.
      </Description>
