...
<Stack horizontal horizontalAlign="space-between" style={{ backgroundColor: '#EFF6FC', padding: '2.25em' }}>
  ...
  <Stack.Item align="center">
    <img src="images/hero.svg" alt="UI Library Hero Image" style={{ maxHeight: '18.75em' }} />
  </Stack.Item>
</Stack>
