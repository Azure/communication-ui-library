...
The same components and composites offered in the UI Library are available in the [Azure Communication Services UI Kit for Figma](ADD LINK), so you can quickly design and prototype your calling and chat experiences.  
