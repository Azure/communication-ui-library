...
| ---------------- | ----------------------------- | ----------------------------- | -------- | -------- | ---------- | ------------ |
| UI Library - Calling | Chrome\*, new Edge            | Chrome\*, Safari\*\*          | Chrome\* | Chrome\* | Chrome\*\* | Safari\*\*\* |
| UI Library - Chat    | Firefox\*, Chrome\*, new Edge | Firefox\*, Chrome\*, Safari\* | Chrome\* | Chrome\* | Chrome\*   | Safari\*\*\* |
