...
import { overviewPageImagesStackStyle, overviewPageUIArtifactsStackStyle } from './constants';
...
<Stack horizontal tokens={{ childrenGap: '1rem' }} wrap>
  <Stack.Item styles={{ root: { ':hover': { textDecoration: 'underline !important' } } }}>
    <a style={overviewPageUIArtifactsStackStyle} href="/docs/quickstarts-composites--page">
      <Stack tokens={{ childrenGap: '1rem' }}>
        ...
        <Stack.Item>
          <Image style={{ width: '100%' }} src="images/composites-teaser.png" alt="Learn more about UI Composites" />
        </Stack.Item>
      </Stack>
    </a>
  </Stack.Item>
  <Stack.Item styles={{ root: { ':hover': { textDecoration: 'underline !important' } } }}>
    <a style={overviewPageUIArtifactsStackStyle} href="/docs/overview-uicomponents--page">
      <Stack tokens={{ childrenGap: '1rem' }}>
        ...
        <Stack.Item>
          <Image style={{ width: '100%' }} src="images/components-teaser.png" alt="Learn more about UI Components" />
        </Stack.Item>
      </Stack>
    </a>
  </Stack.Item>
