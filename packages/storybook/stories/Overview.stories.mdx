...
<Stack
  ...
  style={{ backgroundColor: '#EFF6FC', padding: '2.25rem' }}
>
  <Stack.Item align="center">
    <img
...
For Teams Interop the experience includes lobby functionality for user to wait to be admitted.
...
>
  ...
  <Stack.Item align="center" tokens={{ childrenGap: '2rem' }}>
    <p style={{ textAlign: 'center' }}>
      {'Popup appearing in Teams to admit ACS participant with name "I\'m joing from ACS"'}
    </p>
    <img
...
[ChatComposite](./?path=/story/composites-chat-basicexample--basic-example) is providing achat experience where user can send and receive
messages. Thread events like typing, reads, participants entering and leaving are displayed to the user as part of the chat thread.

Here are visual examples of Chat composite with or without participant list.
...
>
  <Stack.Item align="center">
    <img src="images/chatComposite_WithParticipantsList.png" alt="Chat composite without participants list" />
  </Stack.Item>
  <Stack.Item align="center">
...
<Stack style={{ backgroundColor: '#EFF6FC', padding: '2.25rem' }}>
  <Stack.Item align="center">
