...
import CustomSpotlightCompositeText from '!!raw-loader!./snippets/spotlight/CustomSpotlightComposite.snippet.tsx';
import HideSpotlightText from '!!raw-loader!./snippets/spotlight/HideSpotlight.snippet.tsx';
import SpotlightEventText from '!!raw-loader!./snippets/spotlight/SpotlightEvent.snippet.tsx';

<Meta
  id="spotlight"
  title="Concepts/Spotlight"
...
The spotlight feature enables ACS users add or remove spotlight to participants, including themselves, in the Call and
CallWithChat composites. This allows ACS users to give more focus to one or more participants because everyone in the
callwill see the spotlight participant(s) which can be important when communicating in large groups.
...
Participants can be spotlighted using the contextual menu button on each video gallery tile, including the local
participant, like shown below:

<img style={{ width: 'auto', height: 'auto' }} src="images/spotlight/spotlight-menu-in-video-gallery.png" />

Participants can also be spotlighted using the contextual menu button on each participant in the people pane like shown
below:

<img style={{ width: 'auto', height: 'auto' }} src="images/spotlight/spotlight-menu-in-people-pane.png" />

Spotlighted participants will be seen placed in the main view of VideoGallery like shown below:
...
The spotlight feature is available by default in the Call and CallWithChat composites. If you want to hide the
...
VideoGallery in the Call and CallWithChat composites.
...
Call and CallWithChat composites' behavior of giving more focus to spotlighted participants VideoGallery.
