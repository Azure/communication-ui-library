...
to join a Rooms call. The UI Library is not for creating users, rooms, and adding users to rooms with roles.
...
Next a room needs to be created using the Rooms Client. The Javascript implementation of the Rooms Client is imported from this [repository](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/communication/communication-rooms/).
Then users are added to a room using the Rooms Client with an assigned role.
...
Note: The role may no need to be passed to Call composite in the future and will be pulled from the Calling SDK by the Call composite
...
The Rooms Client is responsible for creating a room. he Javascript implementation can be imported from this [repository](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/communication/communication-rooms/)
...
No, this is the responsibility of the Rooms Client. The Javascript implementation can be imported from this [repository](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/communication/communication-rooms/)
