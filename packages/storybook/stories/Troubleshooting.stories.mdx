...
```
ERROR in /workspaces/communication-ui-library/common/temp/node_modules/.pnpm/htmlparser2@8.0.1/node_modules/htmlparser2/lib/esm/index.js 59:9
...
This issue will occur when using `@azure/communication-react` with a webpack version < 5. The best course of action is to upgrade your webpack version to 5. If this is not possible there are workarounds: https://github.com/fb55/htmlparser2/issues/1237#issuecomment-1182522861.
