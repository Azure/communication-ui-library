...
import { App as QuickstartCompositeExample } from './examples/QuickstartComposite.example.tsx';
import QuickstartCompositeText from '!!raw-loader!./examples/QuickstartComposite.example.tsx';
