...
UI Library components come in two flavors: UI components and composites.
...
For Example: The Chat composite expects that the `userId` associated to the `token` being used to initialize it has already been joined to the `threadId` being provided.
If the token hasn't been joined to the thread ID, then the Chat composite will fail.
...
See the [troubleshooting page](./?path=/docs/troubleshooting--page) for some common problems and recommended solutions.

## Clean Up Resources

If you want to clean up and remove an Azure Communication Services resource, you can delete the resource or resource group.
...
[Try UI Library UI components](./?path=/docs/quickstarts-uicomponents--page)

For more information, see the following resources:

- [UI Library use cases](./?path=/docs/use-cases--page)
- [UI Library styling](./?path=/docs/styling--page)
- [UI Library theming](./?path=/docs/theming--page)
- [UI Library localization](./?path=/docs/localization--page#composites)
