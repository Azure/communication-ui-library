...
if you are creating a new application run the following to create a new react application ready to use the ACS UI
library. You will still need to install the `uuid` package like below.
