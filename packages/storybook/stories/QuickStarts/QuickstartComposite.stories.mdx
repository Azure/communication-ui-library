...
| Name                                               | Description                                                                                        |
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [Call](/?path=/docs/composites-call--basic-canvas) | Composite component that renders a group calling experience with participant gallery and controls. |
| [Chat](/?path=/docs/composites-chat--basic-canvas) | Composite component that renders a group chat experience with chat thread and input                |
