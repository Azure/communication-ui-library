...
| [createStatefulChatClient](/?path=/story/stateful-chat-client-introduction--page)                                               | Method to translate low-level library client into a stateful client for the UI Library               |
...
| [createDefaultChatHandlersForComponent](/?path=/story/stateful-chat-client-introduction--page)                                  | Method to generate method props for UI Components from Stateful Client to handle UI Component events |
