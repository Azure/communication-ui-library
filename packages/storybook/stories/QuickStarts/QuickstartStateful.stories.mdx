...
Stateful clients make it easier for developers to build UI applications on top of Azure Communication Services.
...
At the end of this process, you should have a full application inside the folder `UI-ToolKit-Quickstart`.
...
| [chatClientDeclaratify](/?path=/story/stateful-chat-client-introduction--page)                                                  | Method to translate love-level library client into a stateful client for the UI Toolkit               |
| [declarativeChatClient](/?path=/story/stateful-chat-client-introduction--page)                                                  | Stateful chat client based on the low level chat library client.                                      |
| [chatThreadSelector](/?path=/story/stateful-chat-client-introduction--page)                                                     | Method to generate props for Chat Thread UI Component from Stateful Client                            |
...
| [createDefaultHandlersForComponent](/?path=/story/stateful-chat-client-introduction--page)                                      | Method to generate method props for UI Components from Stateful Client to handle UI Components events |
