...
<Meta id="quickstarts-uicomponents" title="Quickstarts/Get started with UI Components" />
...
npm install --save @azure/communication-react @fluentui/react @fluentui/react-icons@^0.3.9 @fluentui/react-northstar@^0.51.2 @fluentui/react-icons-northstar^0.51.2
