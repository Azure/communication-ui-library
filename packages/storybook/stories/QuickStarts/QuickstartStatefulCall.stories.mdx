...
<Meta id="quickstarts-statefulcallclient" title="Quickstarts/Get Started (Call) " />
...
| Name                                                                       | Description                                                                            |
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [CallClient]()                                                             | Low-level call library client.                                                         |
...
## Instantiate Stateful Call Client and Call Agent
