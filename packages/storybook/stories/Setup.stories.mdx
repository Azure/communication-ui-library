...
Before you get started make sure you have all following prerequisites set up and ready to go.
...
using the new testing library `@testing-library/react` which is not compatible with versions of react `< 18`. If this file is left alone the app will not build correctly in the next step.
