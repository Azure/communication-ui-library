...
Using the UI library in react you will need to downgrade the version of react that you are
currently getting from `create-react-app` since it creates a project
that runs on react 18. This page talks about packages that need downgrading and files
that need to be edited to get you up and running.

## Prerequisites

Before you get started make sure you have all of these things setup and ready to go.
...
using the new testing library `@testing-library/react` which is not compatible with other versions of
react. If this file is left alone the app will not build correctly in the next step.

### Run Create React App

Finally once all of these things have been done you should run:
