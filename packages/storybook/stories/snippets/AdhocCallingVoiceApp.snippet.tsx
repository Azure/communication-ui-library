...
export type ContainerProps = {
  ...
  // Teams resource account ids linked to a call queue or auto attendant need to be in format '28:orgid:<UUID>'. For example,
...
export const ContosoCallContainer = (props: ContainerProps): JSX.Element => {
  ...
  const createTargetCallees = useMemo(() => {
    return fromFlatCommunicationIdentifier(props.microsoftTeamsAppId) as MicrosoftTeamsAppIdentifier;
  }, [props.microsoftTeamsAppId]);
