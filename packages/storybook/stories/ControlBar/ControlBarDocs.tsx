...
export const getDocs: () => JSX.Element = () => {
  return (
    <>
      ...
      <Description>
        You can also easily change the styles of included button components. In the example, below we import
        `CameraButton` and `MicrophoneButton` for the 1st and 2nd buttons and style our own hang up button for the 3rd
        button. Learn more about styling [here](./?path=/docs/styling--page).
      </Description>
      <Canvas withSource={SourceState.NONE}>
