...
<Menu positioning="below-end">
  <MenuTrigger>
    {(triggerProps: MenuButtonProps) => (
      <CameraButton menuButton={triggerProps} icon={<Video20Filled />} isDisabled={boolean} />
    )}
  </MenuTrigger>
...
- Why does persona's avatar take avatar props instead of an avatar component slot? What goes into this decision?
  https://codesandbox.io/s/bold-blackwell-s7wk98?file=/example.tsx
...
- Splitbutton touch behavior has changed - intentional?
