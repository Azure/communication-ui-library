...
| v8                                    | v9                                                                                                           | Usage                                                                                                                                      |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| AnimationStyles                       |                                                                                                              | Drawer, MutedNotification                                                                                                                  |
| CalloutProps                          |                                                                                                              |                                                                                                                                            |
| CommandBarButton                      |                                                                                                              | Close side pane button                                                                                                                     |
| concatStyleSets & mergeStyle          |                                                                                                              | Various                                                                                                                                    |
| ContextualMenu                        |                                                                                                              |                                                                                                                                            |
| ContextualMenuItem                    |                                                                                                              |                                                                                                                                            |
| DefaultButton & PrimaryButton         |                                                                                                              | CallControls, Invite button, Close side pane, Dialpad, Overflow Gallery Navigation, Call Readiness modals, Captions Settings, Start Button |
| Dropdown                              |                                                                                                              | Device Selection, Captions settings, Invite button                                                                                         |
| FocusTrapZone                         |                                                                                                              | Drawer, Config SidePanel                                                                                                                   |
| FocusZone                             |                                                                                                              | Captions, Dialpad, ParticipantList                                                                                                         |
| FontIcon                              |                                                                                                              | Various                                                                                                                                    |
| Icon                                  |                                                                                                              | Various                                                                                                                                    |
| IconButton                            |                                                                                                              | Various                                                                                                                                    |
| Label                                 |                                                                                                              | Various                                                                                                                                    |
| Layer                                 |                                                                                                              | FloatingPip, Pipip, Drawer                                                                                                                 |
| Link                                  |                                                                                                              | CallReadiness modals, Chat Messages                                                                                                        |
| menuProps                             |                                                                                                              |                                                                                                                                            |
| MessageBar                            |                                                                                                              | ErrorBar, TroubleshootingGuideErrorBar, FileDownloadErrorBar, VideoEffectsError, SendBox                                                   |
| Modal & IDragOptions                  | ⚠️ **No v9 equivalent**                                                                                      | CallReadiness, Captions Settings, PiPiP, LocalVideoTile, Dialpad                                                                           |
| Panel                                 |                                                                                                              | Config Page Video Effects                                                                                                                  |
| Persona, PersonaPresence, PersonaSize |                                                                                                              | Captions, Video Tiles, Participant Items, Chat Messages                                                                                    |
| ProgressIndicator                     |                                                                                                              | FileCard                                                                                                                                   |
| Spinner                               |                                                                                                              | Captions, FileDownloadCard, VideoTile, TransferPage, LobbyPage                                                                             |
| Stack                                 | [_shim_](https://react.fluentui.dev/?path=/docs/concepts-migration-from-v8-components-flex-stack--page)      | Various                                                                                                                                    |
| Stack.Item                            | [_shim_](https://react.fluentui.dev/?path=/docs/concepts-migration-from-v8-components-flex-stack-item--page) | Various                                                                                                                                    |
| Text                                  |                                                                                                              | Various                                                                                                                                    |
| TextField                             |                                                                                                              | SendBox, Edit chat message, Dialpad                                                                                                        |
| ThemeProvider                         | FluentProvider                                                                                               | FluentThemeProvider                                                                                                                        |
| TooltipHost                           |                                                                                                              | ControlButtons, Send/complete edit buttons, Message status indicator, VideoEffectsItem                                                     |
| useTheme                              |                                                                                                              | Various                                                                                                                                    |
