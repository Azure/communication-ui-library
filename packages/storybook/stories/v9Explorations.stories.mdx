...
| v8                                              | v9                                                                                                                                      | Usage                                                                                                                                      |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| AnimationStyles                                 | ⚠️ **No v9 equivalent**                                                                                                                 | Drawer (SlideUp), MutedNotification (FadeIn & FadeOut)                                                                                     |
...
<ParticipantList>
  ...
  <Menu>
    ...
    <MenuPopover>
      <MenuList>
        // {createDefaultParticipantListMenuItems().map(item => <MenuItem {...item} />)}
        // <MenuItem>{useLocale().strings.components.correct_string_usage_here}</MenuItem>
        <ParticipantItemMuteItem />
        <ParticipantItemRemoveItem />
      </MenuList>
    </MenuPopover>
  </Menu>
...
>
  <ParticipantMenuList />
  <ParticipantListMenuItemsPerParticipant>
</ParticipantList>
...
- Why does persona's avatar take avatar props instead of an avatar component slot?
- Will dialog be getting drag functionality - is there a intake form for requests?
...
- ~~Is animation for context menus being worked on or is this a design change?~~ Fixed: [https://github.com/microsoft/fluentui/pull/28119](https://github.com/microsoft/fluentui/pull/28119)
- Should we `.` for associating like-components (e.g. Stack and Stack.Item)
