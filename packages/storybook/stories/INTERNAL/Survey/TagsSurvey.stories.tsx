...
import { _TagsSurvey as TagsSurveyComponent, _AudioIssue, _OverallIssue, _ScreenshareIssue, _SurveyTag, _VideoIssue, useTheme } from '@internal/react-components';
...
const TagsSurveyStory = (): JSX.Element => {
  ...
  return (
    ...
    >
       {showSurvey && <TagsSurveyComponent strings={strings} issues={issues} callIssuesToTag={callIssuesToTag}  onDismissTagsSurvey={onDismiss} />}
    </div>
  );
};
