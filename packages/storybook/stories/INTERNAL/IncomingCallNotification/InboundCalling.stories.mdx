...
[IncomingCallStack](./?path=/docs/ui-components-internal-inboundcalling-incomingcallstack--incoming-call-stack) and [IncomingCallNotification](./?path=/docs/ui-components-inboundcalling-incomingcallnotification--incoming-call-notification) Component. These new components will allow you to accept,
