...
const primaryCustomButtonsForInjection: CustomCallControlButtonCallback[] = [
  () => ({
    placement: 'primary',
...
export const PrimaryCustomButtonInjectionExample = (props: CallExampleProps): JSX.Element => {
      ...
      <CallComposite
        ...
        options={{
          callControls: {
            ...
            onFetchCustomButtonProps: primaryCustomButtonsForInjection
          }
        }}
      />
    );
