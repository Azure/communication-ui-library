...
<Meta title="Stateful Chat Client/Selectors" />
...
The `chatParticipantListSelector` provides a list of chat participants that can be used to render a [ParticipantItem](?path=/docs/ui-components-participantitem--participant-item-component) component.
