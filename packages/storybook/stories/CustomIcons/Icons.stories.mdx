...
The method for providing custom icons differs between composites and components. Please read below for more details.

## Composites

There is no setup required for rendering icons inside the `CallComposite` and `ChatComposite`.
