...
| [Video Tile](/?path=/story/ui-components-VideoTileComponent--video-tile-component) | Base component to render participants either with or without video                       |
...
export function CallingComponents() {
  ...
  return (
    <Stack>
      ...
      <ControlBarComponent styles={{ root: { justifyContent: 'center' } }}>
        <DefaultButton
          {...videoButtonProps}
