...
import { App } from './CodeSnippets/CompositeQuickstart.Example.tsx';
import CompositeQuickstartText from '!!raw-loader!./CodeSnippets/CompositeQuickstart.Example.tsx';
...
<Source code={CompositeQuickstartText} />
