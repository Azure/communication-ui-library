...
## Work Needed to Migrate Summary

| Work Item                                      | SWAGs |
| ---------------------------------------------- | ----- |
| Create v9 dev inner loop                       |       |
| Create v8 --> v9 devX transition documentation |       |
| Release v9 alpha/beta packages                 |       |
| Convert all code to v9                         |       |
| Create customer migration plan                 |       |
| Major change ARB sign off                      |       |
| Release v9 stable package                      |       |
| Post-release cleanup                           |       |

## Why we want to upgrade

tbd (list value proposition).
...
1. Thorough Bug Bash & Update Selfhost
...
tbd (list breaking changes).

## Estimated Timeline

tbd (estimate from swags).
