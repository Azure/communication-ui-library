...
- [Lobby Example](/?path=/story/examples-teams-interop--lobby): Sample lobby for participant to wait to be admitted to the call.
- [Compliance banner](/?path=/story/examples-teams-interop--compliance-banner): Sample banner to show the user whether the call is being recorded or not.
- [Teams Theme](/?path=/story/examples-themes--teams): Sample theme that makes the UI Library looks like Microsoft Teams.
