...
|                                                                                                 | Join Azure Communication Services group call                                                                                                                |
...
|                                                                                                 | Screen sharing                                                                                                                                              |
|                                                                                                 | End call                                                                                                                                                    |
| Video Gallery                                                                                   | Remote participants are divided into audio and video participants                                                                                           |
...
|                                                                                                 | Shared screen content displayed on video gallery                                                                                                            |
...
- [Lobby example](./?path=/docs/examples-teamsinterop-lobby--lobby): Sample lobby for participant to wait to be admitted to the call.
- [Compliance banner](./?path=/docs/examples-teamsinterop-compliancebanner--compliance-banner): Sample banner to show the user whether the call is being recorded or not.
- [Teams theme](./?path=/docs/examples-themes-teams--teams): Sample theme that makes the UI Library looks like Microsoft Teams.
...
| Video gallery layout can be modified                |            | ✔             |
