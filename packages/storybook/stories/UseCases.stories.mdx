...
import { SingleLineBetaListBanner } from './BetaBanners/SingleLineBetaBanner';
...
<SingleLineBetaListBanner />

- [File Sharing](./?path=/docs/ui-components-messagethread--message-thread#display-file-attachments-with-messages): Features that allows Teams users to share file attachments as part of chat messages.
- [Inline Images](./?path=/docs/ui-components-messagethread--message-thread#display-inline-image-with-messages): Features that allows Teams users to attach images as part of chat messages.
