  ...
  return (
    <>
      ...
      <Description>
        ...
        [Dropdown](https://developer.microsoft.com/en-us/fluentui#/controls/web/dropdown). We suggest using using the
        devices from the calling sdk and apply them as options in the dropdown. When a user selects an element from the
        dropdown, use the `onChanged` callback to save the result. For this case we are just going to use an array of
