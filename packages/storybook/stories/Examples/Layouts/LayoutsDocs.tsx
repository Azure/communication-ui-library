  ...
  return (
    <>
      ...
      <Description>
        ...
        component from `@azure/react-components` package and `@fluentui/react` package.
      </Description>
      <Description>
        ...
        `VideoTile` from `@azure/react-components` to render each participant. We are not passing in video stream to the
