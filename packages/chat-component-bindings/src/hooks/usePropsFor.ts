...
export type GetSelector<Component extends (props: any) => JSX.Element | undefined> = FilterUndefined<
  | (AreEqual<Component, typeof SendBox> extends true ? SendBoxSelector : undefined)
  | (AreEqual<Component, typeof MessageThread> extends true ? MessageThreadSelector : undefined)
  | (AreEqual<Component, typeof TypingIndicator> extends true ? TypingIndicatorSelector : undefined)
