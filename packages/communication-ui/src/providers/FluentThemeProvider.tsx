...
export const FluentThemeProvider = (props: FluentThemeProviderProps): JSX.Element => {
  ...
  const [fluentTheme, setFluentTheme] = useState<PartialTheme | Theme>(lightTheme);
  const [fluentNorthStarTheme, setFluentNorthStarTheme] = useState<ThemeInput<any>>(teamsTheme);

  const setTheme = (theme: PartialTheme | Theme) => setFluentTheme(theme);
...
export const useFluentTheme = () => useContext(FluentThemeContext);
