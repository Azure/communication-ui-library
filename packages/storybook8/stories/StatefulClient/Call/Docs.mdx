...
UI Library requires a React environment to be setup. Next, we will walk through how to install the necessary UI Library dependencies.
...
At this stage you should see a browser tab open with the default state of the app.
