...
const meta: Meta = {
  ...
  argTypes: {
    ...
    startTogetherModeEnabled: { table: { disable: true } },
    isTogetherModeActive: { table: { disable: true } },
    onCreateTogetherModeStreamView: { table: { disable: true } },
    onStartTogetherMode: { table: { disable: true } },
    onSetTogetherModeSceneSize: { table: { disable: true } },
    togetherModeStreams: { table: { disable: true } },
    togetherModeSeatingCoordinates: { table: { disable: true } },
    onDisposeTogetherModeStreamView: { table: { disable: true } },
