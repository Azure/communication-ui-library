...
const TappingInlineImageStory = (args: ArgsFrom<typeof storyControls>): JSX.Element => {
  ...
  const onInlineImageClicked = (attachmentId: string, messageId: string): Promise<void> => {
    if (args.tapMethod === 'alert') {
      alert(`Image clicked with attachmentId: ${attachmentId}`);
...
export const MessageThreadTappingInlineImage = TappingInlineImageStory.bind({});
