...
export const MessageThreadWithAdaptiveCardExample: () => JSX.Element = () => {
  const adaptiveCardMessageStyles = {
    border: '1px solid black', borderRadius: '5px', marginRight: '20px'
  };

  const onRenderMessage = useCallback((messageProps: MessageProps, defaultOnRender?: MessageRenderer): JSX.Element => {
  ...
  return (
    <MessageThread
      userId={'1'}
      messages={GetHistoryWithAdaptiveCardMessages()}
