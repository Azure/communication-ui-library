...
<Canvas of={UnsupportedBrowserStories.UnsupportedBrowserExamplesDocsOnly} source={{ code: UnsupportedBrowserExamples }} />
...
<Canvas of={UnsupportedBrowserStories.UnsupportedEnvironmentModalsDocsOnly} source={{ code: UnsupportedEnvironmentModals }} />
