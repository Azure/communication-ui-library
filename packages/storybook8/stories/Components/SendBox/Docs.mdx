...
import { Title, Description, Props, Heading, Source, Canvas, Meta, ArgsTable } from '@storybook/addon-docs';
...
<Canvas of={SendBoxStories.SendBoxWithSystemMessageExampleDocsOnly} source = {{code: SendBoxWithSystemMessageExampleText}} />
