...
const mobileCustomButtonsForInjection: CustomCallControlButtonCallback[] = [
  () => ({
    placement: 'primary',
...
export const MobileCustomButtonInjectionExample = (props: CallExampleProps): JSX.Element => {
  ...
  if (adapter) {
    return (
      <CallComposite
        ...
        options={{
          callControls: {
            onFetchCustomButtonProps: mobileCustomButtonsForInjection
          }
        }}
      />
    );
