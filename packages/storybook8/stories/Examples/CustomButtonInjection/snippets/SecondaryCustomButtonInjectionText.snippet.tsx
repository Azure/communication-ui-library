...
const secondaryCustomButtonsForInjection: CustomCallControlButtonCallback[] = [
  () => ({
    placement: 'secondary',
...
export const SecondaryCustomButtonInjectionExample = (props: CallExampleProps): JSX.Element => {
      ...
      <CallComposite
        ...
        options={{
          callControls: {
            ...
            onFetchCustomButtonProps: secondaryCustomButtonsForInjection
          }
        }}
      />
    );
