...
version **1.3.2-beta.1** or later. [Learn more about Rooms calls and the different roles within](path=/docs/rooms).
...
more on using 'Communication as Teams user', click [here](path=/docs/communicationasteamsuser--docs). Currently, the only
