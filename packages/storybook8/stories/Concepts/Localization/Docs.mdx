...
import { CustomLocale } from './CustomLocale.story';
import { LocalizationProvider } from './LocalizationProvider.story';
import { LongTranslations } from './LongTranslations.story';
import { SetRTL } from './SetRTL.story';
import { StringsProperty } from './StringsProperty.story';
import { Truncation } from './Truncation.story';

import CustomLocaleSnippetText from '!!raw-loader!./snippets/CustomLocale.snippet';
import LocalizationProviderSnippetText from '!!raw-loader!./snippets/LocalizationProvider.snippet';
import LocalizedComposites from '!!raw-loader!./snippets/LocalizedComposites.snippet';
import SetRTLSnippetText from '!!raw-loader!./snippets/SetRTL.snippet';
import StringsPropertySnippetText from '!!raw-loader!./snippets/StringsProperty.snippet';
import TruncationSnippetText from '!!raw-loader!./snippets/Truncation.snippet';
...
<table>
  ...
  <tr>
    ...
    <td>COMPONENT_LOCALE_ES_MX</td>
    <td>COMPOSITE_LOCALE_ES_MX</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>French (Canada)</td>
    <td>COMPONENT_LOCALE_FR_CA</td>
    <td>COMPOSITE_LOCALE_FR_CA</td>
  </tr>
  <tr>
    <td>Hebrew (Israel)</td>
...
1. Using styling to set limits and truncating long translations. The following styling in the example below is passed to each button.
