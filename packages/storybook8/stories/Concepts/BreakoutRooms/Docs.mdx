...
in Teams meetings. When the meeting organizer assigns a breakout room to an ACS user and that breakout room is opened,
the composite will automatically change the current call to the breakout room. When the breakout room is closed, the
ACS user will automatically be moved back the the main meeting.
...
### Can ACS users or Teams identity users choose their own breakout room to join?

Can ACS users or Teams identity users will not yet be able to choose their own breakout room like in Teams. The meeting
organizer must assign the breakout room for the ACS user or Teams identity user.
...
Note: ACS Web UI Library cannot be used to manage breakout rooms and their settings
