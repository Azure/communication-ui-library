...
<sub>
  <sup>Layout Menu Displaying the Together Mode Option as Disabled When a Teams User Hasn't Started Together Mode</sup>
</sub>
...
<sub>
  <sup>Layout Menu Showing the Together Mode Option Enabled When a Teams User Has Started Together Mode</sup>
</sub>
