...
Since all different [Node](https://nodejs.org/en) front end libraries are just JavaScript, CSS, and HTML you can use each of the
different frameworks inside each other. In the case of using [React](https://react.dev/) inside your application you would use
...
```ts
...
// This is an example of how you might lazy load the UI library in your application.
