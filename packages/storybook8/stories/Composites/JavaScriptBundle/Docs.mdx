...
<Meta title="Composites/Build your own JavaScript bundle" />
...
Check [Chat Composite](./?path=/docs/composites-chatcomposite--docs), [Call Composite](./?path=/docs/composites-callcomposite--docs), and [CallWithChat Composite](./?path=/docs/composites-callwithchatcomposite--docs) to see optional props of composites

For more details of adapter, check [Adapters for Composites](./?path=/docs/composites-adapters--docs)
