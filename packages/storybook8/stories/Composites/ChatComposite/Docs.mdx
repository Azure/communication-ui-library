...
The insert inline images feature is only supported in the Teams Interop chats. Please try it out in the Join Teams Meeting page.

<Source code={richTextEditorExampleText} />

## Props

<ArgTypes of={ChatComposite} />
