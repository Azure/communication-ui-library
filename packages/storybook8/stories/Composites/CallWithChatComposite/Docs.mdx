...
- Support for sending an image from an ACS end user to a Teams user requires using [Rich Text Editor](http://localhost:6006/iframe.html?viewMode=docs&id=composites-chatcomposite--docs&args=#rich-text-editor-support).
