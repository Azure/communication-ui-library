...
import { panelContentStyle, panelMainStyle } from './styles/Panel.styles';
...
export const SlideOutPanelComponent: FunctionComponent<SlideOutPanelProps> = (
  props: React.PropsWithChildren<SlideOutPanelProps>
): JSX.Element => {
  ...
  return (
    <Panel
      ...
      styles={{ main: panelMainStyle, content: panelContentStyle }}
    >
      {children}
    </Panel>
  );
