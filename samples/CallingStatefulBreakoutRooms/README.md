# Calling Stateful Sample for Breakout Rooms
...
This is a sample application to show how we can use the `@azure/communication-react` package to build a calling experience with breakout rooms.
